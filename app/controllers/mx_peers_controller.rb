class MxPeersController < ApplicationController
  ...
  private
    ...
    def mx_peer_params
      params.require(:mx_peer).permit(:name, :url, :ip, :first_seen, :last_seen, :response_time, :node_type, :distance, :uuid, :trust, :public_key)
    end
end
